...
print "\nInput file containing results from hmmscan program: ";
my $filein=<STDIN>;
chomp($filein);

print "\nInput file containing lengths of HMM models: ";
...
$fileout=$fileout."_e_".$evalue_cutoff."_hmm_cov_".$hmm_fraction_cutoff."_tabular.txt";
=cut
