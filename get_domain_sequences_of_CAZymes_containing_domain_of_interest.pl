...
#use Getopt::Long;
=pod
print "\nInput FASTA file containing all protein sequences (include path): ";
my $filein_fasta=<STDIN>;
chomp($filein_fasta);

print "\nInput file containing list of CAZymes (include path): ";
my $filein_cazymes=<STDIN>;
chomp($filein_cazymes);

print "\nInput domain of interest: ";
my $selected_domain=<STDIN>;
chomp($selected_domain);

print "\nInput name of output fasta file (include path): ";
my $fileout=<STDIN>;
chomp($fileout);
=cut
my $filein_fasta="/home/mnguyen/Research/Lysozyme/GH24_all_15Dec2017/Fungi/11Jul2018/Get_domain_seqs/Fungi_GH24_fulseq_19Jul2018.fasta";
my $filein_cazymes="/home/mnguyen/Research/Lysozyme/GH24_all_15Dec2017/Fungi/11Jul2018/Get_domain_seqs/Fungi_GH24_CAZy_module_19Jul2018.txt";
my $selected_domain="GH24";
my $fileout="/home/mnguyen/Research/Lysozyme/GH24_all_15Dec2017/Fungi/11Jul2018/Get_domain_seqs/Fungi_GH24_domainseq_19Jul2018.fasta";
